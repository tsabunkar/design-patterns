class Creature {
  constructor() {
    ...
    this.stats = new Array(3).fill(10); // statistics
  }
  ...
  // !if we add new property then we violate open-close principle
  /* 
  get sumOfStats() {
  ...
  get averageStat() {
    return this.sumOfStats / 3.0; // 3 -> magic number
  }
...
console.log(
  `Creature has average statistics : ${creature.averageStat}, ` +
