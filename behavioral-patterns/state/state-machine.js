...
// !which transition from one state to another state
// !Trigger is action or event which happens in the system which causes the state transition
...
let state = State.offHook; // initial state
